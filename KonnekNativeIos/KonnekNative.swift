...
//    }
//    
//    @objc public func getFloatingButtonCustomize(fontName: String) -> UIView {
//        let button = DraggableButton()
//        button.addTarget(self, action: #selector(floatingButtonTapped), for: .touchUpInside)
//        // button.translatesAutoresizingMaskIntoConstraints = false
//        button.isUserInteractionEnabled = true
...
//    }
//    
//    @objc public func showFloatingButtonCustomize(fontName: String) {
//        guard let window = UIApplication.shared.windows.first else {
//            //            print("No window found")
//            return
//        }
...
//        
//        if window.viewWithTag(buttonTag) == nil {
//            // let button = getFloatingButtonCustomize(fontName: fontName)
//            let button = getFloatingButton()
//            KonnekNative.floatingButton?.setTextButtonFontStyle(fontName: fontName)
//            button.tag = buttonTag
//            window.addSubview(button)
//        } else {
//            //            print("Floating button already exists")
